...
export default class onlineEvent extends EventListener {
  ...
  async execute(e) {
    logger.mark("----^_^----")
    logger.mark(logger.green(`Aoi-Yunzai 上线成功 版本v${cfg.package.version}`))
    logger.mark(logger.green("https://github.com/codysk/Aoi-Yunzai"))
    // logger.mark('-----------')
    /** 加载插件 */
  ...
  async loginMsg() {
    ...
    let msg = `欢迎使用【Aoi-Yunzai v${cfg.package.version}】\n【#帮助】查看指令说明\n【#状态】查看运行状态\n【#日志】查看运行日志\n【#更新】拉取 Github 更新\n【#全部更新】更新全部插件\n【#更新日志】查看更新日志\n【#重启】重新启动\n【#配置ck】配置公共查询 Cookie`
